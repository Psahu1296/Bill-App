...
import {
  ...
  FaClipboardList, FaUserTie, FaCoffee,
} from "react-icons/fa";
...
const Home: React.FC = () => {
  ...
  const quickActions = [
    { label: "Chai / Sutta", icon: <FaCoffee />,       path: "/consumables", primary: false },
    { label: "Orders",       icon: <FaClipboardList />, path: "/orders",      primary: false },
    { label: "Staff",        icon: <FaUserTie />,       path: "/staff",       primary: false },
  ];
